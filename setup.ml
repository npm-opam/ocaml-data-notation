...
(* OASIS_START *)
(* DO NOT EDIT (digest: a0b9e694984d630f10bd9e809b834f6c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://forge.ocamlcore.org/projects/odn";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("fileutils",
                               Some (OASISVersion.VGreaterEqual "0.4.0"));
                           InternalLibrary "odn";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Darcs;
                      src_repo_location =
                        "http://darcs.ocamlcore.org/repos/ocaml-data-notation";
                      src_repo_browser =
                        Some
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\229ab\222\247\245\025{n\003\212\216K\251\135[";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
